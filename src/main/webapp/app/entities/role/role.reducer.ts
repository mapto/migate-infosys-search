...
export const searchEntities = createAsyncThunk('role/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IRole, thunkAPI) => {
    return axios.post<IRole>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const updateEntity = createAsyncThunk(
  'role/update_entity',
  async (entity: IRole, thunkAPI) => {
    return axios.put<IRole>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IRole, thunkAPI) => {
    return axios.patch<IRole>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IRole>(requestUrl);
  },
  { serializeError: serializeAxiosError }
);
