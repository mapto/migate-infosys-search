...
export const RoleUpdate = () => {
  ...
  const saveEntity = values => {
    const entity = {
      ...roleEntity,
      ...values,
      sponsor: institutions.find(it => it.id.toString() === values.sponsor.toString()),
      person: people.find(it => it.id.toString() === values.person.toString()),
      product: works.find(it => it.id.toString() === values.product.toString()),
    };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...roleEntity,
          sponsor: roleEntity?.sponsor?.id,
          person: roleEntity?.person?.id,
          product: roleEntity?.product?.id,
        };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField id="role-sponsor" name="sponsor" data-cy="sponsor" label="Sponsor" type="select">
                <option value="" key="0" />
                {institutions
              ...
              <ValidatedField id="role-person" name="person" data-cy="person" label="Person" type="select">
                <option value="" key="0" />
                {people
              ...
              <ValidatedField id="role-product" name="product" data-cy="product" label="Product" type="select">
                <option value="" key="0" />
                {works
