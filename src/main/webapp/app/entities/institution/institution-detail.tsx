    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>Institution Role Name</dt>
          <dd>
            {institutionEntity.institutionRoleNames
              ? institutionEntity.institutionRoleNames.map((val, i) => (
                  <span key={val.id}>
                    <a>{val.name}</a>
                    {institutionEntity.institutionRoleNames && i === institutionEntity.institutionRoleNames.length - 1 ? '' : ', '}
                  </span>
                ))
              : null}
          </dd>
