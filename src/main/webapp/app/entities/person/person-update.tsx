  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          language: 'ENGLISH',
          ...personEntity,
          works: personEntity?.works?.map(e => e.id.toString()),
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Work" id="person-work" data-cy="work" type="select" multiple name="works">
                <option value="" key="0" />
                {works
