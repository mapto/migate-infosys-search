...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKGROUP_LIST actions', async () => {
    ...
    it('dispatches SEARCH_WORKGROUPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_WORKGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKGROUP actions', async () => {
      const expectedActions = [
        {
