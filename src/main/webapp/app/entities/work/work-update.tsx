...
export const WorkUpdate = () => {
  ...
  const saveEntity = values => {
    const entity = {
      ...
      responsibility: roles.find(it => it.id.toString() === values.responsibility.toString()),
    };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          responsibility: workEntity?.responsibility?.id,
        };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField id="work-responsibility" name="responsibility" data-cy="responsibility" label="Responsibility" type="select">
                <option value="" key="0" />
                {roles
