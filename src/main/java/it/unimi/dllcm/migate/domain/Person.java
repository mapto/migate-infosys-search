...
public class Person implements Serializable {
    ...
    private Set<Role> jobs = new HashSet<>();
    ...
    public Set<Role> getJobs() {
        return this.jobs;
    }

    public void setJobs(Set<Role> roles) {
        if (this.jobs != null) {
            this.jobs.forEach(i -> i.setPerson(null));
        }
        if (roles != null) {
    ...
    public Person jobs(Set<Role> roles) {
        this.setJobs(roles);
        return this;
    }

    public Person addJob(Role role) {
        this.jobs.add(role);
        role.setPerson(this);
        return this;
    }

    public Person removeJob(Role role) {
        this.jobs.remove(role);
        role.setPerson(null);
        return this;
    }
