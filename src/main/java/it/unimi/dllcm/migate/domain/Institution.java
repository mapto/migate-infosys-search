...
public class Institution implements Serializable {
    ...
    private Set<Role> positions = new HashSet<>();
    ...
    public Set<Role> getPositions() {
        return this.positions;
    }

    public void setPositions(Set<Role> roles) {
        if (this.positions != null) {
            this.positions.forEach(i -> i.setSponsor(null));
        }
        if (roles != null) {
            roles.forEach(i -> i.setSponsor(this));
        }
        this.positions = roles;
    }

    public Institution positions(Set<Role> roles) {
        this.setPositions(roles);
        return this;
    }

    public Institution addPosition(Role role) {
        this.positions.add(role);
        role.setSponsor(this);
        return this;
    }

    public Institution removePosition(Role role) {
        this.positions.remove(role);
        role.setSponsor(null);
        return this;
    }
